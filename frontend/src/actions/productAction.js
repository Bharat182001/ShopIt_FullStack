...
export const getAllReviews = (productId) => async(dispatch) => { // input id is of product ki id
    try {
        dispatch({
...
export const deleteReviews = (reviewId, productId) => async(dispatch) => { // input id is of product ki id
    try {
        dispatch({
